...
if (!isset($_SESSION['oturumid'])){ 
	...
	exit();
		...
		$stmt  = $dbpdo->query("select * from users where id = '$_SESSION[oturumid]' ");
		$yeni = $stmt->fetch();
	...
	<div class="content clearfix" style="padding-top:0">
		...
		<form action="#" method="post" onsubmit="return false;" >
				<div class="login-fields">
						...
						<br>
							...
							<div class="field">
								...
								<input type="text" id="username" name="username" value="<?php echo $user_id;?>" placeholder="Username" class="login" />
							</div> <!-- /field -->
				...
				<div class="field">
					...
					<input type="text" id="name" name="name" value="<?php echo $name;?>" placeholder="Name" class="login" />
				</div> <!-- /field -->
				
				<div class="field">
					<label for="surname">Surname:</label>
					<input type="text" id="surname" name="surname" value="<?php echo $surname;?>" placeholder="Surname" class="login"/>
				</div> <!-- /field -->
				
				<div class="field">
					<label for="hometown">Town:</label>
					<input type="text" id="hometown" name="hometown" value="<?php echo $city;?>" placeholder="Hometown" class="login"/>
				</div> <!-- /field -->
			...
			<div class="field">
				...
				<div class="field">
					...
					<select id="gender" name="gender" class="form-control login" style="width: 295px;"><option value="<?php echo $gender;?>">(<?php echo $gender;?>)</option><option value="Male">Male</option><option value="Female">Female</option><option value="Other">Other</option></select>
				</div> <!-- /field -->
