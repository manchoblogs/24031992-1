...
require_once("../../comments/inc/config.php"); 
	...
	$alanne = " approve = '0'";
	}elseif(isset($_GET['onlyreplies'])){
	$alanne = " (type = 'yorumcevap' or type = 'yorumcevapyanit' ) ";
	}elseif(isset($_GET['onlycomments'])){
	$alanne = " (type != 'yorumcevap' or type != 'yorumcevapyanit' ) ";
	}else{
	$alanne = " approve = '1'  ";
	}	
	...
	$bysite=base64_encode($_GET['bysite']);
		
	$alanne = $alanne ." and domainaccess = '$bysite'";
	}else{
